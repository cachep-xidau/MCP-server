...
let db = null;
export function setupSearchTool(server) {
    server.tool("search_company_kb", "Search the local synced FTS5-BM25 knowledge base for company documents, rules, APIs, and Jira context. USE MULTIPLE SYNONYMS via FTS5 'OR' operators for best results.", {
        ...
        `;
            const params = [query_expansion_keywords];
...
//# sourceMappingURL=search_kb.js.map